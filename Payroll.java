...
public class Main {
    public static void main(String[] args) {
        ...
        Staff staff = new Staff("525","Martha","Vera","F",instance,40);

        instance.set(Calendar.YEAR,1957);
        instance.set(Calendar.MONTH,3);
        instance.set(Calendar.DATE,12);
        Staff staff2 = new Staff("778","Ruiz","Marco","M",instance,40);

        instance.set(Calendar.YEAR,1989);
        instance.set(Calendar.MONTH,11);
        instance.set(Calendar.DATE,3);
        Staff staff3 = new Staff("789","Robert","Lisa","F",instance,35);
        ...
        instance.set(Calendar.YEAR,1963);
        instance.set(Calendar.MONTH,4);
        instance.set(Calendar.DATE,16);
        level = Faculty.Level.AO;
        Faculty faculty1 = new Faculty("791","Mark","Jhon","M",instance,education,level);
        ...
        Faculty faculty2 = new Faculty("364","Kennedy","Michael","M",instance,education,level);

        instance.set(Calendar.YEAR,1964);
        instance.set(Calendar.MONTH,9);
        instance.set(Calendar.DATE,30);
        Parttime partTime = new Parttime("982","Ramon","Rafael","M",instance,35,20);

        instance.set(Calendar.YEAR,1990);
        instance.set(Calendar.MONTH,3);
        instance.set(Calendar.DATE,3);
        Parttime partTime1 = new Parttime("535","Kansas","Agustin","M",instance,30,40);

        instance.set(Calendar.YEAR,1976);
        instance.set(Calendar.MONTH,12);
        instance.set(Calendar.DATE,4);
        Parttime partTime2 = new Parttime("985","Linda","Isabella","F",instance,35,20);
...
*/
       ...
       /*
        ...
        System.out.println("\nTThe total salary per month for all part time staff is: " + total);
        */
        ...
        for(int i=0;i<9;i++)
            total += array[i].monthlyEarning();
        System.out.println("The total salary per month for all employees is : " + total);*/
